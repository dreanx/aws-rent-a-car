        ...
        <div className="mx-9 mt-10">
          ...
          <div className="flex w-full mt-4">
            <input
              type="text"
              id="text"
              className="border border-[#121A25] bg-[#F3971F] placeholder-[#121A25] text-[#121A25] font-normal text-sm rounded-full block w-full p-2.5 "
              placeholder="name"
              required
            />
          </div>
          <div className="flex w-full mt-4">
            <input
              type="text"
              id="country"
              className="border border-[#121A25] placeholder-[#121A25] bg-[#F3971F] text-[#121A25] text-sm rounded-full block w-full p-2.5 "
